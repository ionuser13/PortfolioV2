      ...
      <div className="w-full">
        ...
        <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
          <div className="col-span-4">
            ...
            <h2>Overview</h2>
            <p className="py-4">
              Cattogram is a web app that I developed for cat lovers to enjoy a
              curated feed of cat pictures. With Cattogram, users can save their
              favorite cat photos and upload their own cat pictures.As a
              developer, I wanted to create a project that not only showcased my
              technical skills but also brought joy to users. With Cattogram, I
              aimed to create a fun and enjoyable experience for cat lovers and
              provide a platform for them to share their love for felines.
            </p>
            <Link
              href={"https://github.com/ionuser13/Cat-"}
              target={"_blank"}
            ...
            <Link
              href={"https://ionuser13.github.io/Cat-/"}
              target={"_blank"}
