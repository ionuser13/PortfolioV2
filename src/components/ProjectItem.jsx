...
const ProjectItem = ({title, technology, backgroundImg, projectUrl}) => {
  return (
    <div className='relative flex items-center justify-center h-auto w-full shadow-lg shadow-gray-900 rounded-xl group hover:bg-gradient-to-r from-remarking-color to-light-gradient-color'>
        ...
        <div className='opacity-0 group-hover:opacity-100 absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] transition-all duration-75  ease-in'>
            ...
            <Link href={projectUrl}>
                <p className='text-center py-3 rounded-lg bg-white text-gray-700 font-bold text-lg cursor-pointer hover:bg-gray-300 duration-100'>More info</p>
            </Link>
        </div>
    </div>
  )
