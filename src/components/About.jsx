    ...
    <div className='w-full md:h-screen p-2 flex items-center py-16' id='about'>
        <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
            <div className='col-span-2'>
                ...
                <p className='py-2 text-gray-600 underline cursor-pointer hover:no-underline'>
                  <Link href={"https://github.com/ionuser13?tab=repositories"} target={"_blank"}>Check out some of my latest projects.</Link>
                </p>
            </div>
            <div className='w-fit h-auto m-auto shadow-xl shadow-gray-400 rounded-xl flex justify-center items-center p-4  md:w-full overflow-hidden'>
